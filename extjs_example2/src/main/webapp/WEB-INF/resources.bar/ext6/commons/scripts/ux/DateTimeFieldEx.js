 ...
 */
Ext.define('commons.ux.DateTimeFieldEx', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.datetimefieldex',
    requires: ['commons.ux.DateTimePicker'],
    ...
    getValue : function() {
		var value = this.superclass.getValue.apply(this, arguments);
	    if (value) {
    ...
    createPicker: function() {
        ...
        return Ext.create('commons.ux.DateTimePicker', Ext.merge(initialConfig, parentConfig));
    },
