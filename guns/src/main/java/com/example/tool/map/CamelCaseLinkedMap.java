package com.example.tool.map;

import java.util.HashMap;
import java.util.Map;

import static com.example.tool.map.MapUtil.DEFAULT_INITIAL_CAPACITY;
import static com.example.tool.map.MapUtil.DEFAULT_LOAD_FACTOR;
