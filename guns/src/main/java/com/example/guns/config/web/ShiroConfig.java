...
import com.example.guns.core.interceptor.GunsUserFilter;
...
public class ShiroConfig {
    ...
    public SimpleCookie rememberMeCookie(){
        ...
        simpleCookie.setMaxAge(7 * 24 * 60 * 60); // 7 天
        return simpleCookie;
    }
    ...
    public ShiroFilterFactoryBean shiroFilter(DefaultWebSecurityManager securityManager) {
         ...
         */
        HashMap<String, javax.servlet.Filter> myFilters = new HashMap<>();
